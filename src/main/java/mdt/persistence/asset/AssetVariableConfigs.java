...
import mdt.persistence.asset.jdbc.MultiColumnAssetVariableConfig;
...
public class AssetVariableConfigs {
	...
	public static AssetVariableConfig parseJsonNode(JsonNode jnode) throws IOException {
		...
		switch ( type ) {
			...
			case MultiColumnAssetVariableConfig.SERIALIZATION_TYPE:
				return MultiColumnAssetVariableConfig.deserializeFields(jnode);
