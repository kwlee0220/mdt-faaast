 ...
 */
public class MDTInstanceAutoShutdown extends AbstractScheduledService
										implements Endpoint<MDTManagerHealthMonitorConfig> {
	private static final Logger s_logger = LoggerFactory.getLogger(MDTInstanceAutoShutdown.class);
